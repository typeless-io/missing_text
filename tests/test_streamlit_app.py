...
def test_streamlit_app(
    ...
    # Check if "Process PDF" was clicked
    mock_button.assert_any_call("Process PDF")
...
def test_streamlit_app_no_file(
    mock_title, mock_info, mock_button, mock_file_uploader
):
    ...
    # The new code uses st.info("Please upload and process a PDF file using the sidebar.")
    # when no file is processed.
    mock_info.assert_any_call("Please upload and process a PDF file using the sidebar.")
